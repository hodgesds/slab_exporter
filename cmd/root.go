...
var RootCmd = &cobra.Command{
	Use:   "slab_exporter",
	Short: "Prometheus exporter for slab metrics",
	Long:  ``,
	RunE: func(cmd *cobra.Command, args []string) error {
		config := viper.GetViper()
		collector, err := exporter.NewSlabCollector(config)
		if err != nil {
			return err
		}
...
func initConfig() {
	...
	viper.AddConfigPath("/etc/slab_exporter")
	if err := viper.ReadInConfig(); err == nil {
